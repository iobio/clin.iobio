...
const dTree = {
  ...
  init(data, options = {}) {
    const opts = _.defaultsDeep(options || {}, {
      ...
      callbacks: {
        ...
        nodeSorter(aName, aExtra, bName, bExtra) {
          return 0;
        },
  ...
  _preprocess(data, opts) {
    ...
    var reconstructTree = function(person, parent) {
      ...
      if (person.marriage) {
        ...
        console.log(
          'DEPRECATED: The data attribute "marriage" is deprecated in favor of "marriages" that takes an array. It will be removed in 2.0.'
        );
  ...
  _sortPersons(persons, opts) {
    if (persons != undefined) {
      persons.sort((a, b) =>
        opts.callbacks.nodeSorter(a.name, a.extra, b.name, b.extra)
      );
    }
    return persons;
  },
