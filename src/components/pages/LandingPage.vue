              ...
              <v-layout row wrap>
                ...
                <v-flex xs12 md12 sm12 lg5 xl5>
                  <v-flex text-xs-center class="i-hero_text">
                    ...
                    <span class="i-hero_subheading">
                      clin.iobio allows you to review sequencing and case
                      metrics, generate a prioritized list of genes most highly
                      associated with the disease/phenotype, review and mark
                      variants as significant, and generate a report of your
                      findings.
                    </span>
                    <br />
                    <v-btn
                ...
                <v-flex xs12 md12 sm12 lg5 xl5>
                  <v-flex text-xs-center>
                    <img
                      class="hidden-md-and-down clinical_art"
                      src="../../assets/images/landing_page/clinical_art.svg"
                      alt="Clinical art"
                    />
                  </v-flex>
                </v-flex>
            ...
            <v-flex xs12 sm12 md2 lg2 xl2>
              <v-list rounded class="hidden-sm-and-down">
                ...
                <v-list-item-group v-model="step_number" color="primary">
                  <v-list-item v-for="(step, i) in workflow_steps" :key="i">
        ...
        <v-card>
          ...
          <v-card-text v-if="videoDialog">
            <iframe
              width="560"
              height="315"
              src="https://www.youtube.com/embed/g43CsDVfJIo"
              frameborder="0"
